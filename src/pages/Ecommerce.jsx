...
// import welcomeBg from "../data/welcome-bg.png";
  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        <div className="bg-white dark:text-gray-200dark:bg-secondary-dark-bg h-44 bg-hero-pattern bg-no-repeat bg-contain bg-center rounded-xl w-full lg:w-80 p-8 pt-9 m-3 ">
